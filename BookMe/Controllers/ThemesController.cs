...
namespace BookMe.Controllers
{
    public class ThemesController : Controller
    {
        ...
        public ThemesController(BookMeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Themes != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Themes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ThemeId,Libelle")] Theme theme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ThemeId,Libelle")] Theme theme)
        {
            if (id != theme.ThemeId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Themes'  is null.");
            }
            var theme = await _context.Themes.FindAsync(id);
            if (theme != null)
            {
